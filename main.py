...
_flags.add_argument('--range', type=float, help="feed me a float to min max from")
...
# WITHOUT WINDOW GRABBER AND RANDOMNESS YOU CAN DO A LARGE AMOUNT THROUGH MUCH MORE COMPLEX SCENARIOS.
while(True):
